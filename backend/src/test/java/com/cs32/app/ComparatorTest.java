...
public class ComparatorTest {
  ...
  public void testClickRateComparator() {
    ...
    Poll p1 = new Poll("poll 1", "some emoji", new ArrayList<>(), new CategoryPoints(), "some color");
    Poll p2 = new Poll("poll 2", "some emoji", new ArrayList<>(), new CategoryPoints(), "some color");
  ...
  public void testRelevancyComparator() {
    ...
    Poll p1 = new Poll("poll 1", "some emoji", new ArrayList<>(), userCatPts, "some color");
    ...
    Poll p2 = new Poll("poll 2", "some emoji", new ArrayList<>(), p2CatPts, "some color");
    ...
    Poll p3 = new Poll("poll 3", "some emoji", new ArrayList<>(), p3CatPts, "some color");
